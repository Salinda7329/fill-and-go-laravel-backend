...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.stationowners') }}"
                    class="nav-link {{ request()->routeIs('admin.stationowners') ? 'active' : '' }}"
                    data-tooltip="Station Owners">
                    <svg class="nav-icon" viewBox="0 0 24 24">
                        <path
                    ...
                    <span class="nav-text">Manage Station Owners</span>
                </a>
            </div>
            ...
            <div class="nav-item">
                <a href="{{ route('admin.topups') }}"
                    class="nav-link {{ request()->routeIs('admin.topups') ? 'active' : '' }}" data-tooltip="Top-Ups">
                    <svg class="nav-icon" viewBox="0 0 24 24">
                        <path d="M12 8V4l8 8-8 8v-4.1C7.9 15.9 4 17.8 4 20c0-2.3 3.9-4.1 8-4.1V8z" />
                    </svg>
                    <span class="nav-text">Manage Top-Ups</span>
                </a>
            </div>

            <!-- Add more admin links as needed -->
            {{-- Example for future logs/analytics:
        <div class="nav-item">
            <a href="#" class="nav-link" data-tooltip="System Logs">
                <svg class="nav-icon" viewBox="0 0 24 24">
